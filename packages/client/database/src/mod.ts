...
export type {
  ...
  IGetLobbyQuery,
  IGetLobbyResult,
  IGetWerewolfPlayerIndicesParams,
  IGetWerewolfPlayerIndicesQuery,
  IGetWerewolfPlayerIndicesResult,
...
export type {
  ...
  IGetStuckRoundsParams,
  IGetStuckRoundsQuery,
  IGetStuckRoundsResult,
