...
const upsertGameViewIR: any = {"usedParamSet":{"game_id":true,"phase":true,"round":true,"player_count":true,"alive_count":true,"werewolf_count":true,"villager_count":true,"alive_vector":true,"finished":true,"werewolf_indices":true,"updated_block":true},"params":[{"name":"game_id","required":true,"transform":{"type":"scalar"},"locs":[{"a":165,"b":173}]},{"name":"phase","required":true,"transform":{"type":"scalar"},"locs":[{"a":176,"b":182}]},{"name":"round","required":true,"transform":{"type":"scalar"},"locs":[{"a":185,"b":191}]},{"name":"player_count","required":true,"transform":{"type":"scalar"},"locs":[{"a":194,"b":207}]},{"name":"alive_count","required":true,"transform":{"type":"scalar"},"locs":[{"a":210,"b":222}]},{"name":"werewolf_count","required":true,"transform":{"type":"scalar"},"locs":[{"a":225,"b":240}]},{"name":"villager_count","required":true,"transform":{"type":"scalar"},"locs":[{"a":243,"b":258}]},{"name":"alive_vector","required":true,"transform":{"type":"scalar"},"locs":[{"a":261,"b":274}]},{"name":"finished","required":true,"transform":{"type":"scalar"},"locs":[{"a":277,"b":286}]},{"name":"werewolf_indices","required":true,"transform":{"type":"scalar"},"locs":[{"a":289,"b":306}]},{"name":"updated_block","required":true,"transform":{"type":"scalar"},"locs":[{"a":309,"b":323}]}],"statement":"INSERT INTO werewolf_game_view (\n  game_id, phase, round, player_count, alive_count,\n  werewolf_count, villager_count, alive_vector,\n  finished, werewolf_indices, updated_block\n)\nVALUES (\n  :game_id!, :phase!, :round!, :player_count!, :alive_count!,\n  :werewolf_count!, :villager_count!, :alive_vector!,\n  :finished!, :werewolf_indices!, :updated_block!\n)\nON CONFLICT (game_id) DO UPDATE SET\n  phase            = EXCLUDED.phase,\n  round            = EXCLUDED.round,\n  player_count     = EXCLUDED.player_count,\n  alive_count      = EXCLUDED.alive_count,\n  werewolf_count   = EXCLUDED.werewolf_count,\n  villager_count   = EXCLUDED.villager_count,\n  alive_vector     = EXCLUDED.alive_vector,\n  finished         = EXCLUDED.finished,\n  werewolf_indices = EXCLUDED.werewolf_indices,\n  updated_block    = EXCLUDED.updated_block"};
