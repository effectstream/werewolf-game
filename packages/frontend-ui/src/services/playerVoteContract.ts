 ...
 *   5. BatcherClient intercepts balanceTx, serialises the unproven tx, POSTs to batcher
 ...
 * into an unproven transaction, intercepted at balanceTx, and forwarded to
 * the batcher which generates the ZK proof and submits on-chain.
 *
