...
export class BatcherService {
  ...
  static async sendToBatcher(
    ...
    console.log('[BatcherService] sending to batcher:', { url: BATCHER_URL, target, inputData, requestBody })
  ...
  static async joinGame(
    ...
    const inputData = {
      method: 'joinGame',
      args: [gameId.toString(), midnightAddressHash],
    }
    console.log('[BatcherService] joinGame inputData:', inputData)
    return this.sendToBatcher(address, inputData, signMessage)
  }
}
